...
func (c *streamClient) Conversations(ctx context.Context, opts ...grpc.CallOption) (Stream_ConversationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Stream_ServiceDesc.Streams[0], "/double_stream.proto.Stream/Conversations", opts...)
	if err != nil {
		return nil, err
	}
...
var Stream_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "double_stream.proto.Stream",
	...
	Metadata: "proto/doublestream.proto",
}
