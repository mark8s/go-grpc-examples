...
func (c *streamServerClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/server_side.proto.StreamServer/Route", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamServerClient) ListValue(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (StreamServer_ListValueClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamServer_ServiceDesc.Streams[0], "/server_side.proto.StreamServer/ListValue", opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations should embed UnimplementedStreamServerServer
...
// UnimplementedStreamServerServer should be embedded to have forward compatible implementations.
...
func _StreamServer_Route_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server_side.proto.StreamServer/Route",
	}
...
var StreamServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server_side.proto.StreamServer",
	...
	Metadata: "proto/serverside.proto",
}
